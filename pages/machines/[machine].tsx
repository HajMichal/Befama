...
export const getStaticPaths = ({ locales }: any) => {
  return {
    paths: [
      ...
      { params: { machine: "Laborkrempel und Sonderzweckmaschinen" }, locale: "de" },
      ...
      {
        params: { machine: "Лаболаторные чесальные машины и специального назначения" },
        locale: "ru",
      },
      { params: { machine: "Горизонтальные холстообразователи" }, locale: "ru" },
